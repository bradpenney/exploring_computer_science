...
If you're new to CS, here's a suggested path through this site:
...
5. **[Regular Expressions](regular_expressions.md)** — Practical pattern matching
6. **[How Parsers Work](how_parsers_work.md)** — From theory to implementation
